    ...
    <div className="flex flex-col h-full bg-panel border-l border-white/5">
      ...
      {settingsOpen && (
        <div className="border-b border-white/5 bg-surface px-4 py-4 flex flex-col gap-4">
          ...
          <div>
            <p className="text-xs font-medium text-slate-400 uppercase tracking-wider mb-2">
              {t("chat.graphsPerRowLabel")}:{" "}
              <span className="text-violet-400">{localCount}</span>
            </p>
            <input
              type="range"
              min={1}
          ...
          <div className="mt-8 text-center">
            {!hasKey ? (
              <div className="flex flex-col items-center gap-2">
                <svg
                  className="w-8 h-8 text-yellow-500/80"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={1.5}
                ...
                <p className="text-xs text-slate-500">{t("chat.noKeyHint")}</p>
              </div>
            ) : (
              <div className="flex flex-col items-center gap-2">
                <svg
